...
chrome.downloads.onCreated.addListener(async (downloadItem) => {
  ...
  try {
    ...
    // Check extension rules. Chrome reports a full native path here; extract
    // a safe basename. The G1DM engine re-runs its full filename resolution
    // pipeline, so a generic/empty name never locks in a bad filename.
