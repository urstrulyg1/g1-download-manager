      ...
      <div className="p-5 rounded-2xl bg-slate-900/80 border border-slate-800 shadow-xl space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          ...
          <div className="flex items-end">
            <Button size="md" variant="primary" className="w-full" onClick={handleCreateSnapshot}>
        ...
        {createdSnapshot && (
          <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2 animate-in fade-in text-xs font-mono">
            ...
            <div className="text-slate-400">Total Size: {createdSnapshot.totalBytes} bytes</div>
